...
export async function unloading_report(start_at, group_id, config) {
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    if (group_id != 1) {
      if (
        data[i].truck_name.startsWith("TA30") ||
        data[i].truck_name.startsWith("TA40") ||
        data[i].truck_name.startsWith("TA31") ||
        data[i].truck_name.startsWith("TA41")
      ) {
        if (
          data[i].truck_name != "TA30" &&
          data[i].truck_name != "TA31" &&
          data[i].truck_name != "TA40" &&
          data[i].truck_name != "TA41"
        ) {
          ore_mine_to_cr_tonnage +=
            Number(data[i].ore_cr) * tonnages.big_truck_ore_mine;
          ore_mine_to_magnet_tonnage +=
            (Number(data[i].cf2) +
              Number(data[i].cf2E) +
              Number(data[i].cf3) +
              Number(data[i].lo)) *
            tonnages.big_truck_ore_mine;
          ore_mine_to_road_tonnage +=
            Number(data[i].ore_road) * tonnages.big_truck_ore_mine;
          ore_mine_to_oxide_tonnage +=
            Number(data[i].oxid) * tonnages.big_truck_ore_mine;
          waste_west_tonnage +=
            Number(data[i].waste_gh) * tonnages.big_truck_waste;
          waste_east_tonnage +=
            Number(data[i].waste_sh) * tonnages.big_truck_waste;
          waste_south_tonnage +=
            Number(data[i].waste_jo) * tonnages.big_truck_waste;
          waste_road_tonnage +=
            Number(data[i].waste_in) * tonnages.big_truck_waste;
          ...
          ore_mine_to_cr_tonnage +=
            Number(data[i].ore_cr) * tonnages.small_truck_ore;
          ore_mine_to_magnet_tonnage +=
            (Number(data[i].cf2) +
              Number(data[i].cf2E) +
              Number(data[i].cf3) +
              Number(data[i].lo)) *
            tonnages.small_truck_ore;
          ore_mine_to_road_tonnage +=
            Number(data[i].ore_road) * tonnages.small_truck_ore;
          ore_mine_to_oxide_tonnage +=
            Number(data[i].oxid) * tonnages.small_truck_ore;
          waste_west_tonnage +=
            Number(data[i].waste_gh) * tonnages.small_truck_waste;
          waste_east_tonnage +=
            Number(data[i].waste_sh) * tonnages.small_truck_waste;
          waste_south_tonnage +=
            Number(data[i].waste_jo) * tonnages.small_truck_waste;
          waste_road_tonnage +=
            Number(data[i].waste_in) * tonnages.small_truck_waste;
      ...
      ore_mine_to_cr_tonnage +=
        Number(data[i].ore_cr) * tonnages.belaz_ore_mine;
      ore_mine_to_magnet_tonnage +=
        (Number(data[i].cf2) +
          Number(data[i].cf2E) +
          Number(data[i].cf3) +
          Number(data[i].lo)) *
        tonnages.belaz_ore_mine;
      ore_mine_to_road_tonnage +=
        Number(data[i].ore_road) * tonnages.belaz_ore_mine;
      ore_mine_to_oxide_tonnage +=
        Number(data[i].oxid) * tonnages.belaz_ore_mine;
  ...
  if (group_id == 1) {
    total_tonnage =
      ...
      waste_tonnage +
      depo_tonnage -
      (tonnages.belaz_ore_depo - tonnages.belaz_ore_other_depo) *
        (Number(process.env.novin) + global.Other_D_TO_D);
  } else {
